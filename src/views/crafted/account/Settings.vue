            ...
            <form class="form" @submit.prevent="saveChanges3()">
                ...
                <div class="card-body border-top px-9 py-9">
                    ...
                    >
                        ...
                        >
                            <span class="fw-bolder fs-5 mb-0"
    ...
    setup() {
        ...
        const updateEmail = () => {
            if (updateEmailButton.value) {
                ...
                setTimeout(() => {
                    updateEmailButton.value?.removeAttribute(
                        "data-kt-indicator"
                    );
        ...
        const updatePassword = () => {
            if (updatePasswordButton.value) {
                // Activate indicator
                updatePasswordButton.value.setAttribute(
                    "data-kt-indicator",
                    "on"
                );

                setTimeout(() => {
                    updatePasswordButton.value?.removeAttribute(
                        "data-kt-indicator"
                    );
