            ...
            <div class="row g-0">
                ...
                <div class="col-6">
                    <div class="d-flex align-items-center mb-9 me-2">
                        ...
                        <!--begin::Title-->
                        <div>
                            <div class="fs-5 text-dark fw-bolder lh-1">153</div>
                ...
                <div class="col-6">
                    <div class="d-flex align-items-center mb-9 ms-2">
                        ...
                        <!--begin::Title-->
                        <div>
                            <div class="fs-5 text-dark fw-bolder lh-1">145</div>
                            <div class="fs-7 text-gray-600 fw-bold">
                                Réponses
                            </div>
                        </div>
                ...
                <div class="col-6">
                    <div class="d-flex align-items-center me-2">
                        ...
                        <!--begin::Title-->
                        <div>
                            <div class="fs-5 text-dark fw-bolder lh-1">8</div>
                            <div class="fs-7 text-gray-600 fw-bold">
                                Tâches humaines
                            </div>
                        </div>
